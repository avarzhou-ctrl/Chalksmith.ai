  ...
  return (
    <div className="relative flex min-w-0 items-center gap-3 rounded-xl border border-stone-700/80 bg-stone-900/85 p-3 text-left shadow-lg shadow-black/20 backdrop-blur-sm">
      ...
      <span className="min-w-0">
        <span className="block text-base font-semibold text-stone-100">{label}</span>
        <span className="block truncate text-sm text-stone-400">{detail}</span>
      </span>
    </div>
  );
}
...
const paths = [
  'M240 73 C320 73 320 144 380 144',
  'M240 215 C320 215 320 144 380 144',
  'M620 144 C680 144 680 62 760 62',
  'M620 144 C680 144 680 144 760 144',
  'M620 144 C680 144 680 226 760 226',
];

export default function LessonPipeline() {
  return (
    <figure aria-label="Lesson source to output pipeline" className="relative mx-auto mt-10 w-full max-w-[68rem] rounded-3xl border border-stone-800 bg-stone-950/55 p-4 shadow-2xl shadow-black/30 backdrop-blur-sm sm:p-5">
      <div className="relative hidden min-h-72 md:block">
        ...
        <div className="absolute left-[2%] top-1/2 w-[24%] -translate-y-1/2 space-y-20">
        ...
        <div className="absolute left-1/2 top-1/2 w-[24%] -translate-x-1/2 -translate-y-1/2">
          <div className="animate-forge-pulse rounded-2xl border border-amber-500/50 bg-stone-900 p-4 text-center shadow-xl shadow-amber-950/40 motion-reduce:animate-none">
            ...
            <span className="mt-3 block text-base font-bold text-stone-50">Editable code</span>
            <span className="mt-1 block text-sm text-stone-400">The Chalksmith forge</span>
          </div>
        </div>

        <div className="absolute right-[2%] top-1/2 w-[24%] -translate-y-1/2 space-y-5">
      ...
      <div className="grid gap-3 md:hidden">
        ...
        <div className="mx-auto w-full max-w-48 rounded-2xl border border-amber-500/50 bg-stone-900 p-4 text-center shadow-xl shadow-amber-950/40">
          ...
          <span className="mt-2 block text-base font-bold text-stone-50">Editable code</span>
          <span className="mt-1 block text-sm text-stone-400">The Chalksmith forge</span>
        </div>

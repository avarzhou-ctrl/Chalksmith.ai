...
class MainScene(Scene):
    ...
    def show_decimal(self):
        ...
        # Transition 3/4 to its division form
        division_tex = MathTex(r"= 3 \div 4", font_size=60).next_to(self.current_fraction, RIGHT, buff=0.5)
        self.play(Write(division_tex))
        self.wait(1)
        
        decimal_tex = MathTex(r"= 0.75", font_size=60, color=GREEN).next_to(division_tex, RIGHT, buff=0.5)
    ...
    def show_summary_table(self):
        ...
        # Final cleanup using safe list conversion

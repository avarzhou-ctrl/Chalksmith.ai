...
CHEMISTRY_BLOCKS = (
    BlockDefinition(
        ...
        BlockGuide(
            ...
            "comparing matter at particle scale; atom symbols and species counts must reflect the intended substance and use as the only body block",
    ...
    BlockDefinition(
        ...
        BlockGuide(
            ...
            "the reaction structure and coefficients matter more than a calculation; use as the only body block",

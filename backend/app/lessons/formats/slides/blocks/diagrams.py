...
DIAGRAM_BLOCKS = (
    ...
    BlockDefinition(
        ...
        BlockGuide(
            ...
            "showing short stage labels that move from a start to an end; do not use it for "
            "derivations, substantial formulas, or full-sentence reasoning—use steps instead",

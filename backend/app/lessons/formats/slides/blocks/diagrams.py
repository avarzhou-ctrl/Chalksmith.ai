...
DIAGRAM_BLOCKS = (
    ...
    BlockDefinition(
        ...
        BlockGuide(
            ...
            "teaching energy or food pyramids, needs hierarchies, population structures, or layered priorities; list levels from top to bottom and use as the only body block",
    ...
    BlockDefinition(
        ...
        BlockGuide(
            ...
            "showing classification, organizational hierarchy, taxonomy, or part families; use as the only body block",
    ...
    BlockDefinition(
        ...
        BlockGuide(
            ...
            "showing inputs, transformations, outputs, branching pathways, or cause and effect; use as the only body block",
    ...
    BlockDefinition(
        ...
        BlockGuide(
            ...
            "comparing two categories where their intersection is instructional; use as the only body block",
    ...
    BlockDefinition(
        ...
        BlockGuide(
            ...
            "explaining why one event or problem occurs, especially when causes belong to categories; use as the only body block",
    ...
    BlockDefinition(
        ...
        BlockGuide(
            ...
            "showing Earth, atmosphere, tissue, habitat, or system layers where adjacency and order matter; list layers from top to bottom and use as the only body block",
    ...
    BlockDefinition(
        ...
        BlockGuide(
            ...
            "showing food webs, dependency networks, information transfer, or connected systems that are not a single linear flow; order layers from source to destination and use as the only body block",
    ...
    BlockDefinition(
        ...
        BlockGuide(
            ...
            "sorting examples by low-to-high conceptual properties rather than numeric coordinates; use as the only body block",
    ...
    BlockDefinition(
        ...
        BlockGuide(
            ...
            "teaching electromagnetic bands, acidity ranges, temperature zones, or other ordered continua; list bands from low to high and use as the only body block",
    ...
    BlockDefinition(
        ...
        BlockGuide(
            ...
            "showing scales, boundaries, ecological organization, or containment where being inside another level is the key idea; list rings from outermost to innermost and use as the only body block",
    ...
    BlockDefinition(
        ...
        BlockGuide(
            ...
            "showing Punnett squares, classification grids, state/property lookup, or other categorical intersections; use quadrant-diagram instead when both axes are qualitative continua and use as the only body block",

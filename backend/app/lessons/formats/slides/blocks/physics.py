...
PHYSICS_BLOCKS = (
    BlockDefinition(
        ...
        BlockGuide(
            ...
            "teaching balanced or unbalanced forces, weight, normal force, friction, or applied force; use as the only body block",
    ...
    BlockDefinition(
        ...
        BlockGuide(
            ...
            "teaching wave vocabulary or how amplitude and wavelength are measured; use as the only body block",
